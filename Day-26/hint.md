...
63. # Multitenant Architecture
                        What is Multitenant Architecture?
                        In simple terms, a multitenant architecture is a software architecture where a single instance of the software application serves multiple customers (tenants).
                    --Think of it like a large apartment building:
                --The apartment building is the single software instance (the application and its infrastructure).
            --Each apartment is a tenant (a customer or organization).
        --Each tenant has their own private space (their data and configuration) and shares the common infrastructure (the building's foundation, plumbing, elevators, roof).
    --Each tenant's data is isolated and invisible to other tenants, even though they are all running on the same hardware and software platform.
64. # claudinary learned which work like S3 bucket

- # mpm install dotenv
- dotenv is file which store private sensitive data

# npm instal claudinary

# npm i multer-storage-cloudinary

65. # railway database host step
    # Here’s your Railway MYSQL_PUBLIC_URL:
    mysql://root:ReDWpGhmneMBzpUKeRhnCksnPeknwYky@switchyard.proxy.rlwy.net:53799/railway
...
This is what your dbConfig should be.

66. # to make it online, do this

# Option 1: Stick with Cloudinary v1

# Since multer-storage-cloudinary only supports Cloudinary v1:

npm uninstall cloudinary
npm install cloudinary@1.41.3 multer-storage-cloudinary@4.0.0
Then npm ci
t work this on railway.app
